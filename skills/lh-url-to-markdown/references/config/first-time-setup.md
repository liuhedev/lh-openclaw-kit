...
description: First-time setup flow for lh-url-to-markdown preferences
---
...
options:
  - label: "User (Recommended)"
    description: "~/.lh-skills/ (all projects)"
  - label: "Project"
    description: ".lh-skills/ (this project only)"
```
...
| Choice | Path | Scope |
|--------|------|-------|
| User | `~/.lh-skills/lh-url-to-markdown/EXTEND.md` | All projects |
| Project | `.lh-skills/lh-url-to-markdown/EXTEND.md` | Current project |
